              ...
              for log in receipt.logs:
                  ...
                  if protocol is not None:
                      ...
                      if log['topics'][0].hex() in [erc721_transfer, erc1155_transfer_single, erc1155_transfer_batch]:
                          ...
                          traded_price_eth, currency = get_traded_price_and_currency(tx.trx_hash, log, web3, etherscan_api_key)
                          ...
                          try:
                            ...
                            logger.exception('Exception occurred. Input data not appendend', block_number, ' ', tx['hash'].hex())
                            record = {
                                'fetched_dt': datetime.datetime.now(),
                                "d_contract": contract_type,
                                "d_timestamp": formatted_timestamp,
